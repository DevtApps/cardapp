...
class ProdutoPage extends StatefulWidget {
  ...
  ProdutoPage(this.mesa);
  @override
  _ProdutoPageState createState() => _ProdutoPageState(mesa);
}
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                maxLines: 1,
                                textAlign: TextAlign.center,
                                style: TextStyle(fontSize: size.height * 0.11),
                              ),
                            ],
                          ),
                        ),
            ...
            children: [
              ...
              Container(
                  ...
                  child: FlatButton(
                    ...
                    color: Colors.orange,
                    onPressed: () async {
                      var result = await mesaController.novoPedido(pedidos);
                      if (result)
                        Navigator.pop(context);
                      else
                        Scaffold.of(context).showSnackBar(SnackBar(
